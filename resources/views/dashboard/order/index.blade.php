                    ...
                    <div class="card shadow h-100 py-2" style="border-left: 5px solid #34bfa3 !important">
                        <div class="card-body">
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    <div class="text-xs font-weight-bold text-success">@lang('order.index.delivered')</div>
                                    <div class="h5 mb-0 mt-2 font-weight-bold text-gray-800">{{ $orderDelivered }}</div>
                                </div>
                                <div class="col-auto">
                                    <img src="/image/done.png" width="45">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-xl-3 col-md-6 mb-4">
                    <div class="card shadow h-100 py-2" style="border-left: 5px solid #5867dd !important">
                        <div class="card-body">
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    <div class="text-xs font-weight-bold text-primary">@lang('order.index.shipped')</div>
                                    <div class="h5 mb-0 mt-2 font-weight-bold text-gray-800">{{ $orderShipped }}</div>
                                </div>
                                <div class="col-auto">
                                    <img src="/image/delivery.png" width="45">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-xl-3 col-md-6 mb-4">
                    <div class="card shadow h-100 py-2" style="border-left: 5px solid #f4516c !important">
                        <div class="card-body">
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    <div class="text-xs font-weight-bold text-danger">@lang('order.index.cancel')</div>
                                    <div class="h5 mb-0 mt-2 font-weight-bold text-gray-800">{{ $orderCancel }}</div>
                                </div>
                                <div class="col-auto">
                                    <img src="/image/cancel.png" width="45">
                                </div>
                            </div>
                        </div>
                    </div>
