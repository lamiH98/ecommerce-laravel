                ...
                <form action="{{ route('slider.store') }}"  method="POST" class="m-form m-form--label-align-right" enctype="multipart/form-data">
                    ...
                    <div class="m-portlet__body">
                        <div class="m-form__section m-form__section--first">
                            ...
                            <div class="form-group m-form__group row">
                                <label class="col-lg-2 col-form-label">@lang('slider.create.subtitle'):</label>
                                <div class="col-lg-6">
                                    <input type="text" name="subtitle" id="subtitle" value="{{ old('subtitle') }}" class="form-control m-input" placeholder=@lang('slider.create.subtitle')>
                                </div>
                            </div>
                            <hr>
                            <div class="form-group m-form__group row">
                            ...
                            <div class="form-group m-form__group row">
                                <label class="col-lg-2 col-form-label">@lang('slider.create.subtitle_ar'):</label>
                                <div class="col-lg-6">
                                    <input type="text" name="subtitle_ar" id="subtitle_ar" value="{{ old('subtitle_ar') }}" class="form-control m-input" placeholder=@lang('slider.create.subtitle_ar')>
                                </div>
                            </div>
